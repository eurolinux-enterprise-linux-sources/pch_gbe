%define kmod_name		pch_gbe
%define kmod_driver_version	1.01
%define kmod_rpm_release	2
%define kmod_git_hash		e517f9816e3bd81e9df1660f660af336a5dad9cc
%define kmod_kernel_version	2.6.32-279.el6
%define kernel_version		2.6.32-279.el6
%define kmod_kbuild_dir		drivers/net/pch_gbe/
...
%changelog
* Mon Dec 10 2012 Jiri Benc <jbenc@redhat.com> 1.01 2
- added greylisted symbols

* Tue Dec 04 2012 Jiri Benc <jbenc@redhat.com> 1.01 1
- pch_gbe DUP module
